...
public class SmtRequestConverter extends BaseAbstractConverter<SmtRequestDto, SmtRequest> {
  ...
  @Autowired
  public SmtRequestConverter(SmtProjectConverter smtProjectConverter,
      SmtRequestRecoveryConverter smtRequestRecoveryConverter,
  ...
  protected void doConvertToDto(SmtRequestDto dto, SmtRequest entity) {
    ...
    if (smtRequestHistoryList != null) {
      dto.setSmtRequestHistoryList(
          smtRequestHistoryConverter.convertToDtoList(smtRequestHistoryList));
    }

    List<SmtRequestNotification> smtRequestNotificationList = entity
        .getSmtRequestNotificationList();
    if (smtRequestNotificationList != null) {
      dto.setSmtRequestNotificationList(
          smtRequestNotificationConverter.convertToDtoList(smtRequestNotificationList));
    }
  ...
  protected void doConvertToEntity(SmtRequest entity, SmtRequestDto dto) {
    ...
    if (smtRequestRecoveryDto != null) {
      entity.setSmtRequestRecovery(
          smtRequestRecoveryConverter.convertToEntity(smtRequestRecoveryDto));
    }

    List<SmtRequestHistoryDto> smtRequestHistoryList = dto.getSmtRequestHistoryList();
    if (smtRequestHistoryList != null) {
      entity.setSmtRequestHistoryList(
          smtRequestHistoryConverter.convertToEntityList(smtRequestHistoryList));
    }

    List<SmtRequestNotificationDto> smtRequestNotificationList = dto
        .getSmtRequestNotificationList();
    if (smtRequestNotificationList != null) {
      entity.setSmtRequestNotificationList(
          smtRequestNotificationConverter.convertToEntityList(smtRequestNotificationList));
    }

    List<SmtRequestHeaderDto> smtRequestHeaderList = dto.getSmtRequestHeaderList();
    if (smtRequestHeaderList != null) {
      entity.setSmtRequestHeaderList(
          smtRequestHeaderConverter.convertToEntityList(smtRequestHeaderList));
    }
